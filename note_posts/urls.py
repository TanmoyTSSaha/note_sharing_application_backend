...
from .views import PostListView, PostDetailedView, PostLikeAPIView, CommentAPIView, UserPostAPIView, CommentGetAPIView, CommentPutDeleteAPIView, CommentCountGetAPIView
...
urlpatterns = [
    ...
    path('comment/post_id=<int:post_id>/', CommentCountGetAPIView.as_view(), name='comment-GET'),
